...
export function buildMostPopularVideosRequest(amount = 10, loadDescription = false, nextPageToken,videoCategoryId = null) {
...
export function buildRelatedVideosRequest(videoId, amountRelatedVideos = 10) {
  return buildApiRequest('GET',
    '/youtube/v3/search',
    {
      part: 'snippet',
...
//video details for watch component
